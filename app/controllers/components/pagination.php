 ...
 * @access public
 */
    var $resultsPerPage = array(5,10,20,50);
/**
 ...
 */
	function _initPaging($parameters) {
		...
		// override DEFAULT with USER PREF
		$this->show = $this->othAuth->user('pagination') ? intval($this->othAuth->user('pagination')) : $this->show;

	...
	function build( $ctrapp_summary=array(), $lang=array(), $return_value=NULL ) {
		...
		$return_text .= '
			<h2>
				...
				'.$this->Html->link( $this->Translations->t( 'sop_materials and equipment', $lang ), '/material/materials/index/', array( 'id'=>'h2_material_materials_index' ), NULL, false ).'
		';
		...
		if ( !empty($ctrapp_summary) ) {
				...
				$return_text .= '
					<div id="h2_summary">
						'.$this->Html->link( $display_summary_text, '/material/materials/detail/'.$ctrapp_summary['text']['id'], NULL, NULL, false ).'

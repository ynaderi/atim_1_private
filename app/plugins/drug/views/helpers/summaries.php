	...
	function build( $ctrapp_summary=array(), $lang=array(), $return_value=NULL ) {
		...
		$return_text .= '
			<h2>
				...
				'.$this->Html->link( $this->Translations->t( 'drug administration', $lang ), '/drug/drugs/listall/', array( 'id'=>'h2_drug_drugs_listall' ), NULL, false ).'
		';
		...
		if ( !empty($ctrapp_summary) ) {
				...
				$return_text .= '
					<div id="h2_summary">
						'.$this->Html->link( $display_summary_text, '/drug/drugs/detail/'.$ctrapp_summary['text']['id'], NULL, NULL, false ).'

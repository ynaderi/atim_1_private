	...
	function build( $ctrapp_summary=array(), $lang=array(), $return_value=NULL ) {
		...
		$return_text .= '
			<h2>
				...
				'.$this->Html->link( $this->Translations->t( 'storage layout management', $lang ), '/storagelayout/storage_masters/index/', array( 'id'=>'h2_storagelayout_storage_masters_index' ), NULL, false ).'
		';
		...
		if ( !empty($ctrapp_summary) ) {
				...
				$return_text .= '
					<div id="h2_summary">
						'.$this->Html->link( $display_summary_text, '/storagelayout/storage_masters/detail/'.$ctrapp_summary['text']['id'], NULL, NULL, false ).'

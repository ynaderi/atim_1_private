	...
	function build( $ctrapp_summary=array(), $lang=array(), $return_value=NULL ) {
		...
		$return_text .= '
			<h2>
				...
				'.$this->Html->link( $this->Translations->t( 'sop_standard operating procedures', $lang ), '/sop/sop_masters/listall/', array( 'id'=>'h2_sop_sop_masters_listall' ), NULL, false ).'
		';
		...
		if ( !empty($ctrapp_summary) ) {
				...
				$return_text .= '
					<div id="h2_summary">
						'.$this->Html->link( $display_summary_text, '/sop/sop_masters/detail/'.$ctrapp_summary['text']['id'], NULL, NULL, false ).'

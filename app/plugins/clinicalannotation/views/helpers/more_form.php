			...
			// build PRIMARY radio button set 
				...
				$radio_display .= '
							<tr>
								<td class="label no_border">
									'.$this->Translations->t( 'case_number', $lang ).'
								</td>
								
								<td class="content no_border">
				...
				for ( $i=0; $i<=$last_primary_number; $i++ ) {
					...
					$radio_display .= '
										<tr>
											...
											<td colspan="5">
												<strong>'.$i.( $i=='0' ? ', '.$this->Translations->t( 'no primary', $lang ) : '' ).'</strong>
											</td>
										</tr>
				...
				if ( $include_new_primary ) {
					$radio_display .= '
										<tr>
											...
											<td colspan="5">
												<strong>'.intval($last_primary_number+1).', '.$this->Translations->t( 'new primary', $lang ).'</strong>
											</td>
										</tr>
					';
				}
				...
				$radio_display .= '
								...
								<td class="help no_border">
									<a href="/ctrapp-dev/forms/displayhelp/'.$form_field_name[0].'/'.$form_field_name[1].'?width=400" class="jTip" id="jTip_'.$form_field_name[1].'" name="'.$this->Translations->t( 'case_number', $lang ).'">?</a>
								</td>
							</tr>
				';

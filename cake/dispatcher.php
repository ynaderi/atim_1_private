<?php
/* SVN FILE: $Id: dispatcher.php,v 1.2 2006/11/07 20:19:20 walambre Exp $ */
/**
 ...
 */
	function dispatch($url, $additionalParams=array()) {
		...
		if ($missingController) {
			...
			// Added for CTRApp customization...
			$ctrapp_custom_controller_class = $ctrlClass.'Custom';
			if ( class_exists($ctrapp_custom_controller_class) ) { $controller =& new $ctrapp_custom_controller_class(); }
		}

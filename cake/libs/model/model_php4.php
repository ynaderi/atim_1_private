<?php
/* SVN FILE: $Id: model_php4.php,v 1.2 2006/11/07 20:19:51 walambre Exp $ */
 ...
 */
	function findAllThreaded($conditions = null, $fields = null, $sort = null, $root = null ) {
		return $this->__doThread(Model::findAll($conditions, $fields, $sort), $root);
	}
/**
